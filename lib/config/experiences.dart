...
final List<Experience> experiences = [
  new Experience(
      jobTitle: 'About',
      company: 'Vaishnavi Mittal',
      date: '',
      color: Colors.orange,
      active: true,
      description:
          'I am a computer science student at Eternal Unviversity, Baru Sahib, aspiring to be a successful UI designer. I am born & brought up in Paonta Sahib, HP.\nI am focused on learning new technologies that help build my skills as well as persistent on keeping my knowledge of technology in check with my surroundings.   \n\n'),
  new Experience(
      jobTitle: 'Education',
      company: '',
      date: '',
      ...
      active: true,
      description:
          'Bachelor of Technology, Computer Science Engineering, Eternal University, Baru Sahib, Himachal Pradesh | 2018-22\n\nXI-XII\n(Non-Medical)Govt Girls Senior Secondary School, Paonta Sahib | 2015-17\n\nX\nLoreto Convent Tara Hall, Shimla | 2014-15\n\n'),
  new Experience(
      jobTitle: 'Co-Curriculars',
      company: '',
      date: '',
      color: Colors.orange,
      active: true,
      description:
          'Volunteer mentor in Techshilla, Brau Sahib, which is a startup incubated at Eternal University by our alumni & dedicated for coding & programming for girls.\n\nVolunteer for teaching Python to high school girls in the local schools. \n\n'),
  new Experience(
      jobTitle: 'Skills',
      company: '',
      date: '',
